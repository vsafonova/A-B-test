            ...
            <div className="container navigation">
                ...
                <nav>
                    <ul className="header-navigation">
                        <li className="header-navigation__item active"><a className="header-navigation__link" href="#">Home</a></li>
                        <li className="header-navigation__item"><a className="header-navigation__link" href="#project">Projects</a></li>
                        <li className="header-navigation__item"><a className="header-navigation__link" href="#contacts">Contacts</a></li>
                    </ul> 
                </nav>
                <div className="contacts">
                    <div className="contacts-phone">
                        <a href="tel:+46 76 000 0000" className="header-navigation__link">+46 76 000 0000</a>
                    </div>
            ...
            <div className="header-block">
                ...
                <div className="container">
                    ...
                    <p className="paragraph text-2 ">
                        Get ready-made turnkey repairs on time <br/> 
                        with work time saving up to 45 days and <br/>
                    ...
                    <button className="application active">APPLICATION</button>
                </div>
            </div>
        </header>
   )
